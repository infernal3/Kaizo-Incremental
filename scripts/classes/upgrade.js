class Upgrade {
    ...
    /**
     * Creates new upgrade
     * @param {string} id - Upgrade's ID
     * @param {Object} data - Upgrade's data
     * @param {Function} data.unl - Upgrade's unlock condition
     * 
     * @param {string} data.name - Upgrade's name
     * @param {string} data.description - Upgrade's description
     * 
     * @param {(number|Decimal)} data.max - Upgrade's maximum level
     * 
     * @param {Function} data.cost - Upgrade's function that calculates cost defined by level
     * @param {Function} data.bulk - Upgrade's function that calculates max amount
     * 
     * @param {(string|Currency)} data.currency - Upgrade's currency
     */
    constructor(id,data={}) {
        this.id = id;
    ...
    /**
     * Finds upgrade by ID, if it doesn't exist, returns default
     * @param {string} id - Upgrade's ID
     * @returns {Upgrade}
     */
...
const getInitialUpgrades = () => {
    ...
    Upgrade.create("point\\1",{
        ...
        description() { return `Increase <b>Points</b> by <b>${formatMult(this.base())}</b> per level.` },
    ...
    Upgrade.create("point\\2",{
        ...
        name: "Better Point Generator",
        description() { return `Increase the base of <b>Point Generator</b> by <b>${formatPlus(this.base())}</b> per level.` },
    ...
    Upgrade.create("point\\3",{
        ...
        description() { return `Increase the base of <b>α<sub>2</sub></b> perk by <b>${formatPlus(1)}</b> per level.` },
    ...
    Upgrade.create("point\\4",{
        ...
        description() { return `Increase the exponent of <b>α<sub>3</sub></b> perk by <b>${formatPlus(.5)}</b> per level.` },
    ...
    Upgrade.create("point\\5",{
        ...
        description() { return `The previous <b>Point Upgrades</b> are <b>+1%</b> stronger per level.` },
    ...
    Upgrade.create("point\\6",{
        unl: () => KAIZO.perkOwned(1,8),
        description() { return `Increase the exponent of <b>Points</b> by <b>+1%</b> per level.` },
    ...
    Upgrade.create("prestige\\1",{
        name: "More Prestige",
        description() { return `Increase <b>Prestige Points</b> by <b>${formatMult(this.base())}</b> per level.` },
    ...
    Upgrade.create("prestige\\2",{
        description() { return `Increase the exponent of <b>Prestige Points</b>' effect by <b>${formatPlus(.25)}</b> per level.` },
    ...
    Upgrade.create("prestige\\4",{
        ...
        description() { return `Increase the base of <b>β<sub>2</sub></b> perk by <b>${formatPlus(.05)}</b> per level.` },
    ...
    Upgrade.create("power\\1",{
        name: "Point Tickspeed",
        unl: () => KAIZO.perkOwned(3,6),
        description() { return `Increase <b>Point Dimensions</b> by <b>${formatMult(this.base(),3)}</b> per level.` },
